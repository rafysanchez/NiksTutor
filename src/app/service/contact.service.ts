...
export class ContactService {
  ...
  _contactList: any[] = [
{ ID: 1, FirstName: 'maria', LastName: 'ttttt', Email: 'tttt@dder.com', Contact: '11949648052'}
, { ID: 2, FirstName: 'helio', LastName: 'vvvvv', Email: 'rrrr@dder.com', Contact: '02198767890'}
, { ID: 3, FirstName: 'jose', LastName: 'rrrrr', Email: 'eeee@dder.com', Contact: '11949648052'}
, { ID: 4, FirstName: 'carian', LastName: 'eeee', Email: 'xxx@dder.com', Contact: '11949648052'}
, { ID: 5, FirstName: 'miriam', LastName: 'sssss', Email: 'wwww@dder.com', Contact: '11949648052'}
, { ID: 6, FirstName: 'borghi', LastName: 'xxxx', Email: 'vvvvv@dder.com', Contact: '11949648052'}
...
, { ID: 9, FirstName: 'ultimo', LastName: 'santos', Email: 'santos@dder.com', Contact: '23456890'}
];
  constructor() { }
